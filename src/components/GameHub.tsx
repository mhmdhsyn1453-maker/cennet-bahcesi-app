...
const ComingSoonGame: React.FC<{ title: string; isDarkMode: boolean }> = ({ title, isDarkMode }) => {
  return (
    <div className={`w-full max-w-md mx-auto text-center p-8 border-3 rounded-[2.5rem] shadow-2xl flex flex-col items-center gap-5 relative overflow-hidden ${
      ...
      <p className={`text-xs font-bold leading-relaxed ${isDarkMode ? 'text-slate-350' : 'text-slate-600'}`}>
        Bu heyecan dolu oyun çok yakında Cennet Bahçesi'nde sizlerle olacak! Hazırlıklarımız tüm hızıyla devam ediyor. 🛠️
      </p>
      <div className={`w-full h-px ${isDarkMode ? 'bg-slate-700' : 'bg-slate-200'} my-2`} />
...
export const GameHub: React.FC<GameHubProps> = ({ isDarkMode = false }) => {
  ...
  const toggleGameFullscreen = () => {
    ...
    const isGameFS = document.fullscreenElement && document.fullscreenElement.id === 'game-fullscreen-container';
  ...
  const handleQuitGame = () => {
    if (document.fullscreenElement && document.fullscreenElement.id === 'game-fullscreen-container') {
...
// ==========================================
// 8. INDIVIDUAL GAME 6: KİM MİLYONER OLMAK İSTER? - Moved to games/MillionaireQuizGame.tsx
// ==========================================

// ==========================================
// 9. INDIVIDUAL GAME 7: HAZİNE AVCISI (KELİME AVI) - Moved to games/WordSearchGame.tsx
// ==========================================
...
// ==========================================
// 9. INDIVIDUAL GAME 7: ZAMAN ŞERİDİ - Moved to games/ChronologyGame.tsx
// ==========================================

// WheelOfWisdomGame was moved to games/SoruCarkiGame.tsx
